...
public class PlayerHealth : MonoBehaviour
{
    ...
    {
        if(collision.gameObject.CompareTag("EnemyBullet") || collision.gameObject.CompareTag("Enemy") || collision.gameObject.CompareTag("Box") || collision.gameObject.CompareTag("Boss"))
        {
